...
export default function SaasEditsPage() {
...
>
  ...
  Performance-driven SaaS edits crafted for digital growth.
</p>
...
<div className="absolute right-[6%] bottom-[18%] hidden xl:block">
  ...
  <div className="relative h-[90px] w-[90px] border border-black/5">
